...
def delete_story_draft(sender, instance, created, **kwargs):
...
def delete_recipe_draft(sender, instance, created, **kwargs):
    ...
    if created:
        # Also delete any "new recipe" draft since it's now created.
        Draft.objects.filter(
            user=instance.author,
            target_type='recipe',
            target_id__isnull=True
